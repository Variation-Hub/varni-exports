    ...
    <>
      <div className={Style.sliderImages}>
        <div className={Style.titel}>
          <h3 className={Style.offering}>What we’re offering</h3>
          <h2 className={Style.our}>Our Products</h2>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className={Style.sliderText}>
                  <h2 className={Style.text1}>{slider.name}</h2>
        ...
        <div className={Style.titel}>
          <h2 className={Style.our}>Our Categories</h2>
        </div>
          ...
          {catagories.map((slider, index) => {
            return (
              <div key={index}>
                ...
                <h3 className={Style.name_category}>{slider.name}</h3>
              </div>
            );
          })}
        </Slider>
