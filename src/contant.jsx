...
import banner1PNG from "./assets/Banner/banner-1.png"
...
import sesameseed01 from "./assets/Products/sesame/38-0.png";
...
import pulesProduct1 from "./assets/Products/pules/88.png";
import pulesProduct2 from "./assets/Products/pules/89.png";
import pulesProduct3 from "./assets/Products/pules/90.png";
import pulesProduct4 from "./assets/Products/pules/91.png";
import pulesProduct5 from "./assets/Products/pules/92.png";
import pulesProduct6 from "./assets/Products/pules/93.png";
import pulesProduct7 from "./assets/Products/pules/94.png";
import pulesProduct8 from "./assets/Products/pules/95.png";
import pulesProduct9 from "./assets/Products/pules/96.png";
import pulesProduct10 from "./assets/Products/pules/97.png";
import pulesProduct11 from "./assets/Products/pules/98.png";
import pulesProduct12 from "./assets/Products/pules/99.png";
...
export const catagories = [
  {
    ...
    products_detail: [

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Premier Source for Bold Peanut Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Why Choose Bold Peanut Seeds from Varni Exports?</strong></h3>
            <br />
            ...
            <h3><strong>Exceptional Quality and Varieties</strong></h3>
            <br />
            ...
            <h3><strong>Our Bold Peanut Varieties:</strong></h3>
            <br />
            ...
            <h3><strong>Culinary and Industrial Uses</strong></h3>
            <br />
            ...
            <h3><strong>Visit Our Peanut Processing Unit</strong></h3>
            <br />
            ...
            <h3><strong>Why Choose Varni Exports?</strong></h3>
            <br />
            ...
            <h3><strong>Explore and Order Now</strong></h3>
            <br />
            ...
            <h3><strong>Benefits of Bold Peanut Seeds</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            ...
            <li><strong>Protein Source:</strong> With approximately 34% protein,  are highly recommended for pre-workout diets for athletes and older adults.</li>
            ...
            <p>Choose Varni Exports for the finest G20  and experience the unmatched quality and flavor of our products. Contact us today to learn more and place your order.</p>
          </div>,
      },
...

  {
    ...
    products_detail: [

      {
        ...
        "Salmonella ETO": "Absent 25gm / NA",
        "Pesticide Residues": "Within EU Regulations",
        "Micro Test Parameter": "As Per Buyer's Requirement",
        "GMO Status": "Not Genetically Modified",
        "Labelling": "As Per Buyer's Requirement",
        "Packing": "10 KG Multiwall Paper Bags, 22.68 KG Multiwall Paper Bags, 25 KG PP Bags",
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Leading Sesame Seeds Exporters in India</strong></h3>
            <br />

            <p>Sesame seeds exporters in India are always supplying natural sesame seeds items at the best possible costs and in the most exquisite potential quality. This is why sesame seed exporters in India, such as us, have grown in popularity across the country and beyond.</p>
            <br />

            <h3><strong>Premium Quality Natural Sesame Seeds</strong></h3>
            <br />
            <p>Natural sesame seed is an important ingredient in many countries, especially in the Middle East and Asia. India has emerged as the world’s highest exporter of sesame seeds. Sesame seeds have multiple uses and serve as an ideal topping in bakery products, offering a crunchy texture and a slightly sweet, nutty flavor.</p>
            <br />

            <h3><strong>Versatile Culinary Applications</strong></h3>
            <br />
            <p>Natural sesame seeds are widely used in:</p>
            <li><strong>Bakery Products:</strong> Adds texture and flavor to rolls, crackers, cookies, pastries, and cakes.</li>
            <li><strong>Salads & Savory Dishes:</strong> Enhances flavors in a variety of dishes.</li>
            <li><strong>Confectionery & Candy Making:</strong> Commonly used in sweets and snacks.</li>
            <li><strong>Tahini & Sesame Oil Production:</strong> Used for cooking and in the manufacturing of perfumes, pharmaceuticals, and cosmetic products.</li>
            <br />

            <h3><strong>Health Benefits of Natural Sesame Seeds</strong></h3>
            <br />
            <p>Natural sesame seed products provide several health advantages that improve overall well-being. Their nutritional profile includes:</p>
            <li><strong>Rich in Essential Minerals:</strong> High levels of calcium, iron, magnesium, and phosphorus.</li>
            <li><strong>Vitamin B1 Source:</strong> Helps in maintaining energy levels.</li>
            <li><strong>Heart Health:</strong> May support cardiovascular function.</li>
            <li><strong>Bone Strength:</strong> Contributes to better bone health.</li>
            <br />

            <h3><strong>Trusted Sesame Seeds Exporter in India</strong></h3>
            <br />
            <p>We are reliable sesame seed exporters in India, ensuring thorough inspection of each product before delivering it to end-users or consumers. Our commitment to quality and excellence makes us a preferred choice for sesame seeds worldwide.</p>
            <br />

            <h3><strong>Contact Us</strong></h3>
            <br />
            <p>At Varni Exports, we are dedicated to providing the best natural sesame seeds. Our expertise and commitment to quality make us a trusted name in the industry. Reach out to us to learn more about our products and place your order.</p>
            <br />

            <p>Choose Varni Exports for premium sesame seeds and experience superior quality. Contact us today and discover the difference!</p>
          </div>
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Premier Source for Black Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>High-Quality Black Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Culinary and Medicinal Uses</strong></h3>
            <br />
            ...
            <h3><strong>Leading Exporter of Black Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>State-of-the-Art Processing</strong></h3>
            <br />
            ...
            <h3><strong>Uses and Benefits of Black Sesame Seeds</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Source for High-Quality Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Premium Brown Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Cultivation and Harvesting</strong></h3>
            <br />
            ...
            <h3><strong>Leading Exporter of Brown Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Uses and Benefits of Brown Sesame Seeds</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Premier Source for Hulled Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Premium Hulled Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Leading Exporter of Hulled Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Uses and Benefits of Hulled Sesame Seeds</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Premier Source for Roasted Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>High-Quality Roasted Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Why Choose Roasted Sesame Seeds from Varni Exports?</strong></h3>
            <br />
            ...
            <h3><strong>Leading Exporter of Roasted Sesame Seeds</strong></h3>
            <br />
            ...
            <h3><strong>Uses and Benefits of Roasted Sesame Seeds</strong></h3>
            <br />
        ...
        products_detail: [
          {
            ...
            description:
              <div>
                <h3><strong>Premium Cumin Powder from Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Cumin Powder</strong></h3>
                <br />
                ...
                <h3><strong>Historical Significance and Culinary Uses</strong></h3>
                <br />
                ...
                <h3><strong>Partner with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Discover Premium Coriander Powder with Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Coriander Powder</strong></h3>
                <br />
                ...
                <h3><strong>Versatility and Unique Flavor</strong></h3>
                <br />
                ...
                <h3><strong>Medicinal Benefits</strong></h3>
                <br />
                ...
                <h3><strong>Aroma and Taste</strong></h3>
                <br />
                ...
                <h3><strong>Packaging and Quality</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Discover Turmeric: The "Queen of Spices" with Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Turmeric</strong></h3>
                <br />
                ...
                <h3><strong>Indian Turmeric: The Best in the World</strong></h3>
                <br />
                ...
                <h3><strong>Health Benefits of Turmeric</strong></h3>
                <br />
                <ol>
...

          {
            ...
            description:
              <div>
                <h3><strong>Discover Fenugreek Powder with Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Fenugreek Powder</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Discover Dry Ginger Powder with Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Dry Ginger Powder</strong></h3>
                <br />
                ...
                <h3><strong>Historical and Medicinal Uses</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Nutmeg Powder: A Delightful Spice from Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Nutmeg Powder</strong></h3>
                <br />
                ...
                <h3><strong>Origin and Flavor Profile</strong></h3>
                <br />
                ...
                <h3><strong>Medicinal and Health Benefits</strong></h3>
                <br />
                ...
                <h3><strong>Quality Assurance at Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Curry Powder: A Versatile Spice Blend from Varni Exports</strong></h3>
                <br />

                <h3><strong>Introduction to Curry Powder</strong></h3>
                <br />
                ...
                <h3><strong>Origins and Ingredients</strong></h3>
                <br />
                ...
                <h3><strong>Versatility in Culinary Applications</strong></h3>
                <br />
                ...
                <h3><strong>Explore the World of Curry with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Black Pepper Powder: The King of Spices</strong></h3>
                <br />
                ...
                <h3><strong>Explore the World of Black Pepper with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Amchur Powder: The Tangy Spice</strong></h3>
                <br />
                ...
                <h3><strong>Origin and Harvesting</strong></h3>
                <br />
                ...
                <h3><strong>Flavor Profile and Culinary Uses</strong></h3>
                <br />
                ...
                <h3><strong>Discover the Flavor of Amchur with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Anardana Powder: A Tangy Delight in Indian Cuisine</strong></h3>
                <br />
                ...
                <h3><strong>Origin and Production</strong></h3>
                <br />
                ...
                <h3><strong>Experience Authentic Indian Flavors with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Chili Powder: Adding Spice and Health to Your Cuisine</strong></h3>
                <br />
                ...
                <h3><strong>Culinary Significance</strong></h3>
                <br />
                ...
                <h3><strong>Experience Authentic Flavor with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Fennel Powder: Nutritious and Flavorful Addition to Your Kitchen</strong></h3>
                <br />
                ...
                <h3><strong>Experience Fennel Powder with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Yellow Mustard Powder: Enhance Your Cuisine with Quality and Flavor</strong></h3>
                <br />
                ...
                <h3><strong>Experience Excellence with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Introduction to Five-Spice Powder</strong></h3>
                <br />
                ...
                <h3><strong>Explore the World of Flavors with Varni Exports</strong></h3>
                <br />
...

          {
            ...
            description:
              <div>
                <h3><strong>Introduction to Garam Masala</strong></h3>
                <br />
                ...
                <h3><strong>Explore Garam Masala with Varni Exports</strong></h3>
                <br />
          ...
          [
            {
              ...
              description:
                <div>
                  <h3><strong>Welcome to Varni Exports: Your Trusted Supplier of Premium Cumin Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>About Cumin Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>Varieties of Cumin Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>Health Benefits of Cumin Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>Language Variants</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Varni Exports: Your Trusted Supplier of Premium Coriander Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>About Coriander</strong></h3>
                  <br />
                  ...
                  <h3><strong>Health Benefits of Coriander Seeds</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Welcome to Varni Exports: Your Reliable Source for Premium Fenugreek Seeds</strong></h3>
                  <br />

                  <h3><strong>About Fenugreek</strong></h3>
                  <br />
                  ...
                  <h3><strong>Characteristics of Fenugreek</strong></h3>
                  <br />
                  ...
                  <h3><strong>Cultivation and Processing</strong></h3>
                  <br />
                  ...
                  <h3><strong>Global Uses</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Welcome to Varni Exports: Your Reliable Source for Premium Fennel Seeds</strong></h3>
                  <br />

                  <h3><strong>About Fennel Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>Medicinal Uses</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Premium Mustard Seeds from Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Mustard Seeds</strong></h3>
                  <br />
                  ...
                  <h3><strong>Quality and Varieties</strong></h3>
                  <br />
                  ...
                  <h3><strong>Health Benefits and Home Remedies</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Premium Turmeric (Haldi) from Varni Exports</strong></h3>
                  <br />
                  ...
                  <h3><strong>Quality and Production</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Premium Indian Chilli from Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Chilli</strong></h3>
                  <br />
                  ...
                  <h3><strong>Leading Producer and Exporter</strong></h3>
                  <br />
                  ...
                  <h3><strong>Varieties and Uses</strong></h3>
                  <br />
                  ...
                  <h3><strong>Quality and Harvest</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Varni Exports: Premium Red Chilli Flakes</strong></h3>
                  <br />

                  <h3><strong>Introduction to Red Chilli Flakes</strong></h3>
                  <br />
                  ...
                  <h3><strong>Export Excellence by Varni Exports</strong></h3>
                  <br />
                  ...
                  <h3><strong>Usage and Application</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Varni Exports: Premium Dry Ginger</strong></h3>
                  <br />

                  <h3><strong>Introduction to Dry Ginger</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Varni Exports: Nutmeg</strong></h3>
                  <br />

                  <h3><strong>Introduction to Nutmeg</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Black Pepper by Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Black Pepper</strong></h3>
                  <br />
                  ...
                  <h3><strong>Varni Exports' Commitment</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Clove by Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Clove</strong></h3>
                  <br />
                  ...
                  <h3><strong>Varni Exports' Expertise</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Cardamom by Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Cardamom</strong></h3>
                  <br />
                  ...
                  <h3><strong>Quality Assurance and Packaging</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Nigella Seeds (Kalonji Seeds)</strong></h3>
                  <br />
                  ...
                  <h3><strong>Medicinal Properties</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Discover the Essence of Dill Seeds with Varni Exports</strong></h3>
                  <br />
                  ...
                  <h3><strong>Culinary Delight</strong></h3>
                  <br />
                  ...
                  <h3><strong>Culinary and Beyond</strong></h3>
                  <br />
                  ...
                  <h3><strong>Enjoy Dill with Varni Exports</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Explore the Essence of Indian Bay Leaf with Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Origin and Name</strong></h3>
                  <br />
                  ...
                  <h3><strong>Aromatic Profile</strong></h3>
                  <br />
                  ...
                  <h3><strong>Discover Indian Bay Leaf with Varni Exports</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Discover Ajwain Seeds with Varni Exports</strong></h3>
                  <br />
                  ...
                  <h3><strong>Explore Ajwain Seeds with Varni Exports</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Introducing Caraway Seeds with Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Origins and Characteristics</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Introducing Celery Seeds with Varni Exports</strong></h3>
                  <br />
                  ...
                  <h3><strong>Trust Varni Exports for Exceptional Quality and Service</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Discover Cinnamon with Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Cinnamon</strong></h3>
                  <br />
                  ...
                  <h3><strong>Cultivation and Conditions</strong></h3>
                  <br />
                  ...
                  <h3><strong>Commercial Products and Uses</strong></h3>
                  <br />
                  ...
                  <h3><strong>Cinnamon Oils</strong></h3>
                  <br />
                  ...
                  <h3><strong>Health Benefits and Culinary Uses</strong></h3>
                  <br />
                  ...
                  <h3><strong>Contact Varni Exports Today</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Explore Mace with Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Mace</strong></h3>
                  <br />
                  ...
                  <h3><strong>Cultivation and Harvest</strong></h3>
                  <br />
                  ...
                  <h3><strong>Commercial Uses and Products</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Discover Star Anise with Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Star Anise</strong></h3>
                  <br />
                  ...
                  <h3><strong>Origin and Cultivation</strong></h3>
                  <br />
                  ...
                  <h3><strong>Culinary and Aromatic Uses</strong></h3>
                  <br />
                  ...
                  <h3><strong>Pharmaceutical Significance</strong></h3>
                  <br />
                  ...
                  <h3><strong>Health Benefits of Star Anise</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Introducing Tamarind Seeds from Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Overview of Tamarind</strong></h3>
                  <br />
                  ...
                  <h3><strong>Processing and Utilization</strong></h3>
                  <br />
...

            {
              ...
              description:
                <div>
                  <h3><strong>Dry Greater Galangal from Varni Exports</strong></h3>
                  <br />

                  <h3><strong>Introduction to Dry Greater Galangal</strong></h3>
                  <br />
                  ...
                  <h3><strong>Market Reach</strong></h3>
                  <br />
    ...
    products_detail: [
      {
        ...
        description: <div>
          <h3><strong>Welcome to Varni Exports: Your Trusted Source for Premium Chickpeas</strong></h3>
          <br />
          ...
          <h3><strong>High-Quality Chickpeas</strong></h3>
          <br />
          ...
          <h3><strong>Leading Exporter of Chickpeas</strong></h3>
          <br />
          ...
          <h3><strong>Uses and Benefits of Chickpeas</strong></h3>
          <br />
          ...
          <h3><strong>Global Reach and Export Destinations</strong></h3>
          <br />
...

      {
        ...
        "description": <div>
          <h3><strong>Premium Quality Soybean (Glycine max) Exporter</strong></h3>
          <br />
          ...
          <h3><strong>Health Benefits of Soybeans</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Uses of Soybeans</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Why Choose Our Soybeans?</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Leading Supplier & Exporter</strong></h3>
          <br />
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        description: <div>
          <h3><strong>Premium Quality Cowpea (Black-Eyed Beans) Exporter</strong></h3>
          <br />
          ...
          <h3><strong>High-Quality Cowpea Seeds</strong></h3>
          <br />
          ...
          <h3><strong>Leading Exporter of Cowpea</strong></h3>
          <br />
          ...
          <h3><strong>Why Choose Our Cowpea?</strong></h3>
          <br />
          <ul>
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        description: <div>
          <h3><strong>Premium Quality Mung Bean (Green Gram) Exporter</strong></h3>
          <br />
          ...
          <h3><strong>High-Quality Mung Bean Varieties</strong></h3>
          <br />
          ...
          <h3><strong>Leading Exporter of Green Gram</strong></h3>
          <br />
          ...
          <h3><strong>Why Choose Our Mung Bean?</strong></h3>
          <br />
          <ul>
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        description: <div>
          <h3><strong>Premium Quality Vigna Radiata (Mung Bean) Exporter</strong></h3>
          <br />
          ...
          <h3><strong>Varieties of Moong Dal</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Why Choose Our Vigna Radiata?</strong></h3>
          <br />
          <ul>
...

      {
        ...
        "40' FT Container": "-",
        description: <div>
          <h3><strong>Yellow Lentils – Premium Quality from Varni Exports</strong></h3>
          <br />
          ...
          <h3><strong>Nutritional Benefits of Yellow Lentils</strong></h3>
          <br />
          ...
          <h3><strong>Culinary Uses of Yellow Lentils</strong></h3>
          <br />
          ...
          <h3><strong>Premium Quality Assurance</strong></h3>
          <br />
          ...
          <h3><strong>Global Export of Yellow Lentils</strong></h3>
          <br />
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        "description": <div>
          <h3><strong>Premium Quality Black Gram (Urad Dal) Exporter</strong></h3>
          <br />
          ...
          <h3><strong>Health Benefits of Black Gram</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Uses of Black Gram</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Why Choose Our Black Gram?</strong></h3>
          <br />
          <ul>
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        "description": <div>
          <h3><strong>Premium Quality Split Black Lentils (Urad Dal Split) Exporter</strong></h3>
          <br />
          ...
          <br />
          <h3><strong>Versatile Uses of Urad Dal Split</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Why Choose Our Split Black Lentils?</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Leading Exporter of Urad Dal Split</strong></h3>
          <br />
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        "description": <div>
          <h3><strong>Premium Quality Kidney Beans Exporter</strong></h3>
          <br />
          ...
          <br />
          <h3><strong>Why Kidney Beans?</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Our Kidney Beans Export Standards</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Leading Kidney Beans Supplier & Exporter</strong></h3>
          <br />
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        "description": <div>
          <h3><strong>Premium Quality Sorghum (Jowar) Exporter</strong></h3>
          <br />
          ...
          <br />
          <h3><strong>Why Choose Sorghum?</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Our Sorghum Export Standards</strong></h3>
          <br />
          <ul>
          ...
          <br />
          <h3><strong>Leading Sorghum Supplier & Exporter</strong></h3>
          <br />
...

      {
        ...
        "Foreign Matter": "0.01",
        "description": <div>
          <h3><strong>Premium Quality Red Quinoa Exporter</strong></h3>
          <br />
          ...
          <h3><strong>Health Benefits of Red Quinoa</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Why Choose Our Red Quinoa?</strong></h3>
          <br />
          <ul>
            <li><strong>High Purity:</strong> 99% purity with minimal foreign matter.</li>
          ...
          <h3><strong>Applications of Red Quinoa</strong></h3>
          <br />
...

      {
        ...
        "Packing": "10 Kg, 15 Kgs, 25 Kgs / Lbs, PP Bags, Paper Bags, Jute Bags",
        "description": <div>
          <h3><strong>Premium Quality Green Lentils Exporter</strong></h3>
          <br />
          ...
          <h3><strong>Health Benefits of Green Lentils</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Uses of Green Lentils</strong></h3>
          <br />
          <ul>
          ...
          <h3><strong>Why Choose Our Green Lentils?</strong></h3>
          <br />
          <ul>
    ...
    products_detail: [
      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Golden Raisins Supplier</strong></h3>
            <br />

            <h3><strong>About Golden Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Premium Quality Golden Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Golden Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Golden Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Golden Long Raisins Supplier</strong></h3>
            <br />

            <h3><strong>About Golden Long Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Premium Quality Golden Long Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Golden Long Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Golden Long Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Supplier of Golden Round Raisins</strong></h3>
            <br />

            <h3><strong>About Golden Round Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Golden Round Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Golden Round Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Sourcing and Sustainability</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Reliable Supplier of Green Raisins</strong></h3>
            <br />

            <h3><strong>About Green Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Green Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Green Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Supplier of Sultanas Raisins</strong></h3>
            <br />

            <h3><strong>About Sultanas Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Sultanas Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Sultanas Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Discover Premium Black Raisins with Varni Exports</strong></h3>
            <br />

            <h3><strong>About Black Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Black Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Black Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Explore Quality Brown Raisins with Varni Exports</strong></h3>
            <br />

            <h3><strong>About Brown Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Brown Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Brown Raisins</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Discover Premium Yellow Raisins with Varni Exports</strong></h3>
            <br />

            <h3><strong>About Yellow Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Culinary Uses of Yellow Raisins</strong></h3>
            <br />
            ...
            <h3><strong>Health Benefits of Yellow Raisins</strong></h3>
            <br />
    ...
    products_detail: [
      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Partner for Red Onion Export</strong></h3>
            <br />

            <h3><strong>High-Quality Red Onions from Fertile Regions</strong></h3>
            <br />
            ...
            <h3><strong>Variety of Onions Offered</strong></h3>
            <br />
            ...
            <h3><strong>Optimal Growing Regions</strong></h3>
            <br />
            ...
            <h3><strong>Comprehensive Supplier and Exporter</strong></h3>
            <br />
            ...
            <h3><strong>Life Cycle and Cultivation</strong></h3>
            <br />
            ...
            <h3><strong>Nutritional Benefits of Red Onions</strong></h3>
            <br />
            ...
            <h3><strong>Uses and Benefits of Red Onions</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Partner for Yellow Onion Export</strong></h3>
            <br />

            <h3><strong>High-Quality Yellow Onions from Fertile Regions</strong></h3>
            <br />
            ...
            <h3><strong>Nutritional Benefits of Yellow Onions</strong></h3>
            <br />
            <p>Onions are rich in nutrients and vitamins, offering numerous health benefits. Including onions in your daily diet can significantly enhance your overall health.</p>
            <br />

            <h3><strong>Uses and Benefits of Yellow Onions</strong></h3>
            <br />
            <li><strong>Nutrient-Rich:</strong> Low in calories but high in essential minerals and vitamins, including Vitamin B and Vitamin C, which aid in red blood cell formation and nerve function.</li>
            <li><strong>Heart Health:</strong> Contains antioxidants that reduce heart disease risk, inflammation, and blood clot formation.</li>
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Partner for White Onion Export</strong></h3>
            <br />

            <h3><strong>High-Quality White Onions from Fertile Regions</strong></h3>
            <br />
            ...
            <h3><strong>Nutritional Benefits of White Onions</strong></h3>
            <br />
            <p>Onions are rich in nutrients and vitamins, offering numerous health benefits. Including onions in your daily diet can significantly enhance your overall health.</p>
            <br />

            <h3><strong>Uses and Benefits of White Onions</strong></h3>
            <br />
            <li><strong>Nutrient-Rich:</strong> Low in calories but high in essential minerals and vitamins, including Vitamin B and Vitamin C, which aid in red blood cell formation and nerve function.</li>
            <li><strong>Heart Health:</strong> Contains antioxidants that reduce heart disease risk, inflammation, and blood clot formation.</li>
...

      {
        ...
        description:
          <div>
            <h3><strong>Welcome to Varni Exports: Your Trusted Partner for Pink Onion Export</strong></h3>
            <br />

            <h3><strong>High-Quality Pink Onions from Fertile Regions</strong></h3>
            <br />
            ...
            <h3><strong>Nutritional Benefits of Pink Onions</strong></h3>
            <br />
            <p>Onions are rich in nutrients and vitamins, offering numerous health benefits. Including onions in your daily diet can significantly enhance your overall health.</p>
            <br />

            <h3><strong>Uses and Benefits of Pink Onions</strong></h3>
            <br />
            <li><strong>Nutrient-Rich:</strong> Low in calories but high in essential minerals and vitamins, including Vitamin B and Vitamin C, which aid in red blood cell formation and nerve function.</li>
            <li><strong>Heart Health:</strong> Contains antioxidants that reduce heart disease risk, inflammation, and blood clot formation.</li>
...

  {
    ...
    products_detail: [
...

      {
        ...
        description:
          <div>
            <h3><strong>Green Millet: A Nutritious Grain for a Healthier Lifestyle</strong></h3>
            <br />
            ...
            <h3><strong>Experience Green Millet with Varni Exports</strong></h3>
            <br />
    ...
    products_detail: [
      {
        ...
        description:
          <div>
            <h3><strong>Roasted Gram with Skin: A Nutritious and Delicious Snack</strong></h3>
            <br />
            ...
            <h3><strong>Flavor and Preparation</strong></h3>
            <br />
            ...
            <h3><strong>Nutritional Elements</strong></h3>
            <br />
            ...
            <h3><strong>Experience Quality with Varni Exports</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Roasted Gram Whole Without Skin: A Nutritious and Versatile Snack</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Roasted Gram Split Without Skin: A Nutritious Pulse for Indian Cuisine</strong></h3>
            <br />
    ...
    products_detail: [
      {
        ...
        description:
          <div>
            <h3><strong>Soya Chunks: A Nutritious Addition to Your Diet</strong></h3>
            <br />
            ...
            <h3><strong>Versatile Use in Cooking</strong></h3>
            <br />
            ...
            <h3><strong>Quality and Safety</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Fryums: A Crispy Delight from India</strong></h3>
            <br />
            ...
            <h3><strong>Preparation and Cooking</strong></h3>
            <br />
            ...
            <h3><strong>Popular Varieties</strong></h3>
            <br />
            ...
            <h3><strong>Discover Fryums with Varni Exports</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Poha Thin: A Traditional Indian Breakfast Delight</strong></h3>
            <br />
            ...
            <h3><strong>Enjoy Poha Thin with Varni Exports</strong></h3>
            <br />
...

      {
        ...
        description:
          <div>
            <h3><strong>Poha Thick: A Hearty Version of Traditional Indian Flattened Rice</strong></h3>
            <br />
            ...
            <h3><strong>Experience Poha Thick with Varni Exports</strong></h3>
            <br />
...
export const landingPageSlider = [
  {
    title: "Premium Quality Peanut Exporter",
    description: "Exporting high-quality raw, blanched, and roasted peanuts worldwide.",
    image: banner1PNG,
  },
  {
...
export const contactUsSection = {
  ...
  contact1: "+91 99090 62111",
  contact2: "+91 99245 81694",
  email1: "inquiry@varniexports.com",
  email2: "info@varniexports.com",
};
...
export const Slider_products = [
  ...
  },
  {
    ...
    "name": "Dehydrated Red Onion Flakes",
    "image": dehydrated3,
    "path": "/products/dehydrated-product/Dehydrated Red Onion Flakes"
  },
  {
